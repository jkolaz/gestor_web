...
if(IS_PRODUCTION){
    define('SERVER_ADMIN', 'http://www.jkolaz.com/gestor/');
    define('SERVER_APP', 'http://www.jkolaz.com/sanjuan/');
}else{
    define('SERVER_ADMIN', 'http://www.contenidos.devel/');
    define('SERVER_APP', 'http://www.sanjuandedios.devel/');    
}
