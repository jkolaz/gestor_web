...
<html lang="es">
    ...
    <head>
        ...
        <meta property="og:image" content="{$SERVER_IMG}img_redes310x310.html" />
        ...
        <meta name="twitter:image" content="{$SERVER_IMG}img_redes310x310.html" />
        ...
        <link rel="icon" type="image/x-icon" href="{$SERVER_IMG}favicon.png" />
        <link rel="icon" type="image/png" href="{$SERVER_IMG}favicon.png" />

        <link href="{$SERVER_CSS}bootstrap.min.css" rel="stylesheet">
        <link href="{$SERVER_CSS}styles-theme.css" rel="stylesheet">

        <!--Google Fonts-->
        <link href='http://fonts.googleapis.com/css?family=Yanone+Kaffeesatz:400,300,700' rel='stylesheet' type='text/css'>
        <link href='http://fonts.googleapis.com/css?family=PT+Sans:400,700' rel='stylesheet' type='text/css'>
        <link rel="stylesheet" href="{$SERVER_CSS}font-awesome.min.css">
        ...
        <!-- CSS DE JQUERY -->
        <link href="{$SERVER_JS}jquery.bxslider/jquery.bxslider.min.css" rel="stylesheet" />
        <link rel="stylesheet" href="{$SERVER_JS}jquery.youmax/youmax.css"/>
        <link href="{$SERVER_JS}jquery.pwi/css/pwi.css" rel="stylesheet" type="text/css"/>
        <link rel="stylesheet" href="{$SERVER_JS}jquery.pwi/js/jquery.fancybox/source/jquery.fancybox8cbb.css?v=2.1.5" type="text/css" media="screen" />
    </head>
                    ...
                    <div class="col-xs-12 col-sm-3 clearfix">
                        ...
                        <h1 class="pull-left anim-suave">
                            <a href="index.html">
                                ...
                                <img class="anim-suave" src="{$SERVER_IMG}logo_p2.png" alt="Centro de reposo San Juan de Dios Piura | Perú">
                            </a>
                        </h1>
                    </div>
            ...
            <div class="slider-principal-contenido">
                <div class="container">
                    <div class="slider-principal">
                        <ul>
                            <li>
                                    <img class="img-responsive pull-right" src="{$SERVER_IMG}slidea1.jpg">
                            </li>
                            <li>
                                  <img class="img-responsive pull-right" src="{$SERVER_IMG}slidea2.jpg">
                            </li>
                            <li>
                                  <img class="img-responsive pull-right" src="{$SERVER_IMG}slidea3.jpg">
                            </li>
                            <li>
                                  <img class="img-responsive pull-right" src="{$SERVER_IMG}slidea4.jpg">
                            </li>
                            <li>
                                  <img class="img-responsive pull-right" src="{$SERVER_IMG}slidea5.jpg">
                            </li>
                            <li>
                                  <img class="img-responsive pull-right" src="{$SERVER_IMG}slidea6.jpg">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="pie__logo clearfix text-center">
                        <div class="col-xs-12 col-md-4">
                            ...
                            <span>Centro de reposo San Juan de Dios Piura | Perú</span>
                                <img class="img-responsive margen" src="{$SERVER_IMG}logo_p2.png" width="260" alt="Centro de reposo San Juan de Dios Piura | Perú" style="margin-top: 10px;">
                            </a>
                        </div>
    ...
    <!-- jQuery -->
    <script src="{$SERVER_JS}jquery.min.js"></script>
    <script src="{$SERVER_JS}bootstrap.min.js"></script>


    <!-- bxSlider: slider principal -->
	<script src="{$SERVER_JS}jquery.bxslider/jquery.bxslider.min.js"></script>
    <script>
	...
	<!--Twitter -->
	<script type="text/javascript" src="{$SERVER_JS}jquery.twitter/js/twitterFetcher_min.js"></script>
	...
	<!-- These files are the PWI files -->
		...
		<script type="text/javascript" src="{$SERVER_JS}jquery.pwi/js/jquery.fancybox/source/jquery.fancybox.pack8cbb.js?v=2.1.5"></script>
		<script type="text/javascript">
			$(document).ready(function() {
				$(".fancybox").fancybox();
			});
	...
	<script src="{$SERVER_JS}jquery.pwi/js/jquery.pwi.js" type="text/javascript"></script>
	<script type="text/javascript">
	...
	<script type="text/javascript" src="{$SERVER_JS}jquery.gmap/jquery.gmap.min.js"></script>
        {literal}
	<script type="text/javascript">
